...
print(f"safety_neurons shape: {safety_neurons.shape}") # safety_neurons shape: (4608, 1)
...
print(f"safety_neurons columns: {safety_neurons.columns}") # safety_neurons columns: Index(['0'], dtype='object', length=1)
